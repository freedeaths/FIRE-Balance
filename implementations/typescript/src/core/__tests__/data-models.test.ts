...
describe("PortfolioConfiguration", () => {
  ...
  test("valid unique names", () => {
    ...
    const displayNames = config.asset_classes.map(
...
describe("Validation Functions", () => {
  test("validateAllocationSum", () => {
    ...
    expect(() => validateAllocationSum(invalidPortfolio)).toThrow(
  ...
  test("validateBirthYear", () => {
    ...
    expect(() => validateBirthYear(1949)).toThrow(
      "Birth year must be between 1950",
    );
    expect(() => validateBirthYear(2030)).toThrow(
      "Birth year must be between 1950",
    );
  });
  ...
  test("validateAgeProgression", () => {
    ...
    expect(() => validateAgeProgression(invalidProfile)).toThrow(
      "Ages must follow progression",
    );
  });
});
