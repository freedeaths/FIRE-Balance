...
export const colors = {
  ...
  primary: {
    ...
    300: '#fdba74',
    400: '#fb923c',
    500: '#f97316', // Main brand color (FIRE orange)
    600: '#ea580c',
    700: '#c2410c',
    800: '#9a3412',
    900: '#7c2d12',
...
// =============================================================================
// CSS Variables Export (for use with CSS-in-JS or CSS modules)
// =============================================================================
...
export const cssVariables = {
  ...
  '--transition-duration': animation.duration[200],
  '--transition-ease': animation.ease['in-out'],
} as const;
